...
/*
Tenkan       = (9day-high + 9day-low) / 2
Kijun        = (26day-high + 26day-low) / 2
Senkou SpanA = (Tenkan + Kijun) / 2
Senkou SpanB = (52day-high + 52day-low) / 2
Chikou Span  = Close plotted 26days in the past
*/
...
func Hv(inReal []float64, inTimePeriod int) []float64 {
	...
	return talib.StdDev(change, inTimePeriod, math.Sqrt(1)*1000)
}
